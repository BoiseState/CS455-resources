...
/**
 * Modified from the original example from http://www.dreamsyssoft.com/java-8-lambda-tutorial/.
 *
 */
public class UserTestWithLambdas
{
	...
	// List<Integer> binAges = users.stream().map(u -> u.age/10).collect(Collectors.toList());
