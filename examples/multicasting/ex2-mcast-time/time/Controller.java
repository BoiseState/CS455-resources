...
/**
 * Main Application for this package.  It spawns both a client and
 * a server thread.  If the user presses enter, it sends out a 
 * request to the client to announce themselves to the server.
 *
 */
public class Controller {

	/**
	 * Sends out the request when the user presses enter.  Exits when they
	 * type "quit". 
	 * @param args none
	 */
