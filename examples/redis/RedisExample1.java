...
public class RedisExample1
{
	...
	// It is possible to serialize an object into a byte array and put it in as a
	// value but then we lose some of the benefits of Redis so it isn't recommended.
	// To get around it, we could store a list of account names or a map of account
	// names with values being whatever we want. Let us see how to use lists in Redis.
