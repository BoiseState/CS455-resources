 ...
 * firewalls. Note that the rmiregistry has to be on a different port. It is
 * possible to have that be on the same port as well.
 * 
...
public class DateServerImpl implements DateServer
{
    ...
    /**
     * Binds server to registry using custom socket factories for both server and
     * client side. This helps with a firewall by reducing to two ports to punch
     * through the firewall. Otherwise RMI uses anonymous random ports.
     * 
     * @param name
