...
/**
 * An implementation of the Hello remote interface using RMI and fixed port for
 * clients to connect with. This makes it easier to get through a firewall.
 */
public class HelloServer implements Hello {
	...
	{
		if (args.length != 2) {
			System.err.println("Usage: java hello.server.HelloServer <serverport> <registryPort>");
			System.exit(1);
		}
