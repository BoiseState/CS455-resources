...
Wait for ready message from the server before running the clients. This server will serve
clients with two interfaces, in English and French!  To run the clients, use:
